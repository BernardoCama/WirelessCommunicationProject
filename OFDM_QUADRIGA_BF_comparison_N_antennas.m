...
grid on;
title('Contellation revealed by 2x2 antenna array');
legend('Simple BF', 'Null-steering BF', 'MVDR BF', 'LMS BF', 'MMSE BF');
...
grid on;
title('Contellation revealed by 4x4 antenna array');
legend('Simple BF', 'Null-steering BF', 'MVDR BF', 'LMS BF', 'MMSE BF');
...
grid on;
title('Contellation revealed by 8x8 antenna array');
legend('Simple BF', 'Null-steering BF', 'MVDR BF', 'LMS BF', 'MMSE BF');
...
grid on;
title('Contellation revealed by 16x16 antenna array');
legend('Simple BF', 'Null-steering BF', 'MVDR BF', 'LMS BF', 'MMSE BF');

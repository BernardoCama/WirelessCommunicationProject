...
chOut = collectPlaneWave(Geometry.BSarray, [w1],... % attention to dimension of waveforms
        [Geometry.DOAV1Start'], Pars.fc);
chOutInt = collectPlaneWave(Geometry.BSarray, [w2],... % attention to dimension of waveforms
